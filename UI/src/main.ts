import novelWorksScreen from "./ui/novel_works.ui.ts";
import novelEditorScreen from "./ui/novel_editor.ui.ts";
import novelMaterialsScreen from "./ui/novel_materials.ui.ts";
import novelOutlineScreen from "./ui/novel_outline.ui.ts";
import novelStatsScreen from "./ui/novel_stats.ui.ts";
import novelToolsScreen from "./ui/novel_tools.ui.ts";
import novelWorkspaceScreen from "./ui/novel_workspace.ui.ts";
import novelIOScreen from "./ui/novel_io.ui.ts";
import novelRelationshipScreen from "./ui/novel_relationship.ui.ts";
import novelTomatoScreen from "./ui/novel_tomato.ui.ts";
