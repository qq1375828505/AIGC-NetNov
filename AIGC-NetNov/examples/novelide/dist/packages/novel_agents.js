...
exports.NovelAgentDispatcher = exports.AGENT_CONFIGS = void 0;
...
class NovelAgentDispatcher {
    ...
    static async dispatch(agentId, task, context) {
        const agent = exports.AGENT_CONFIGS[agentId];
        if (!agent) {
     ...
     */
    static getAgents() {
        return Object.values(exports.AGENT_CONFIGS).map(agent => ({
            id: agent.id,
            name: agent.name,
...
exports.NovelAgentDispatcher = NovelAgentDispatcher;
// 注册 Agent 工具
